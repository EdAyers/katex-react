...
defineFunction({
    ...
    handler: ({parser, funcName}, args) => {
        ...
        const denom = args[1];
        let hasBarLine;
        let leftDelim : null | string = null;
        let rightDelim : null | string = null;
        let size = "auto";
...
defineFunction({
    ...
    handler({parser}, args) {
        ...
        let hasBarLine;
        let barSize : null | Measurement = null;
        if (barNode.isBlank) {
        ...
        let size = "auto";
        let styl : any = checkNodeType(args[3], "ordgroup");
        if (styl) {
