...
import{ParseNode, AnyParseNode, NodeType} from "./parseNode";
import Options from "./Options";
import{ArgType, BreakToken, Mode} from "./types";
...
export type FunctionHandler<T extends AnyParseNode> = (
    context: FunctionContext,
    args: AnyParseNode[],
    optArgs: (null | AnyParseNode)[],
) => T;

export type HtmlBuilder<T extends AnyParseNode> = (nd : T, o:Options) => HtmlDomNode;
export type MathMLBuilder<T extends AnyParseNode> = (
    group: T,
    options: Options,
) => MathDomNode;
...
export type HtmlBuilderSupSub<T extends AnyParseNode> =
    (nd : supsub | T, o: Options) => HtmlDomNode;
...
type FunctionDefSpec<T extends AnyParseNode> = {
 ...
 */
export type FunctionSpec<T extends AnyParseNode> = {
 ...
 */
export const _functions: {[k:string]: FunctionSpec<any>} = {};

/**
 * All HTML builders. Should be only used in the `define*` and the `build*ML`
 * functions.
 */
export const _htmlGroupBuilders: {[k:string]: HtmlBuilder<any>} = {};

/**
 * All MathML builders. Should be only used in the `define*` and the `build*ML`
 * functions.
 */
export const _mathmlGroupBuilders: {[k:string]: MathMLBuilder<any>} = {};

export default function defineFunction<T extends AnyParseNode>({
    type,
    // nodeType,
    names,
    props,
 ...
 */
export function defineFunctionBuilders<T extends AnyParseNode>({
