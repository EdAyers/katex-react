...
const fontMetricsBySizeIndex: {[fsi in FontSizeIndex]?: FontMetrics} = {};

/**
 * Get the font metrics for a given size.
 */
export function getGlobalMetrics(size: number): FontMetrics | undefined {
    ...
    if (!fontMetricsBySizeIndex[sizeIndex]) {
        ...
        fontMetricsBySizeIndex[sizeIndex] = metrics
    }
